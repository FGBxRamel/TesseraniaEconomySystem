...
Status: `[ ]` in progress — implemented on `feat/stage-1-item-shops`, PR #7 open, manual in-game testing complete (two rounds of tester-reported bugs fixed 2026-08-18/22), merging
Implements: §3.1.1.1
