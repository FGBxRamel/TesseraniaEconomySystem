...
- **Testing**: in-game plugin behavior is hard to automate. When a feature needs real verification, ask the user to test it on the server and report back rather than assuming it works from a successful build.
